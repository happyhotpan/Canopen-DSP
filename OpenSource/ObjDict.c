...
/* index 0x1000 :   Device Type. */
                    ...
                    subindex ObjDict_Index1000[] =
                     {
                       { RO, uint32, 4*sizeof (UNS32), (void*)&ObjDict_obj1000 }
                     };
                    ...
                    subindex ObjDict_Index1003[] =
                     {
                       ...
                       { RO, uint32, 4*sizeof (UNS32), (void*)&ObjDict_obj1003[0] }
                     };

/* index 0x1005 :   SYNC COB ID. */
                    UNS32 ObjDict_obj1005 = 0x80  + NodeId;	/* 128 */
                    ...
                    subindex ObjDict_Index1005[] =
                     {
                       { RW, uint32, 4*sizeof (UNS32), (void*)&ObjDict_obj1005 }
                     };
...
/****************************************************************************************************
  邱家齐修改：增加ObjDict_obj100C与ObjDict_obj100D，其实没有用到，只是因为CO_Data结构体定义了
****************************************************************************************************/
                    UNS16 ObjDict_obj100C;
                    UNS8 ObjDict_obj100D;
                    ...
                    subindex ObjDict_Index1010[] =
                     {
                       ...
                       { RW, uint32, 4*sizeof (UNS32), (void*)&ObjDict_obj1010_Save_All_Parameters },
                       { RW, uint32, 4*sizeof (UNS32), (void*)&ObjDict_obj1010_Save_Communication_Parameters },
                       { RW, uint32, 4*sizeof (UNS32), (void*)&ObjDict_obj1010_Save_Application_Parameters },
                       { RW, uint32, 4*sizeof (UNS32), (void*)&ObjDict_obj1010_Save_Manufacturer_Parameters }
                     };
                    ...
                    subindex ObjDict_Index1011[] =
                     {
                       ...
                       { RW, uint32, 4*sizeof (UNS32), (void*)&ObjDict_obj1011_Restore_All_Default_Parameters },
                       { RW, uint32, 4*sizeof (UNS32), (void*)&ObjDict_obj1011_Restore_Communication_Default_Parameters },
                       { RW, uint32, 4*sizeof (UNS32), (void*)&ObjDict_obj1011_Restore_Application_Default_Parameters },
                       { RW, uint32, 4*sizeof (UNS32), (void*)&ObjDict_obj1011_Restore_Manufacturer_Default_Parameters }
                     };

/* index 0x1014 :   Emergency COB ID. */
                    UNS32 ObjDict_obj1014 = 0x80 + NodeId;	/* 128 */
                    subindex ObjDict_Index1014[] =
                     {
                       { RW, uint32, 4*sizeof (UNS32), (void*)&ObjDict_obj1014 }
                     };
                    ...
                    subindex ObjDict_Index1016[] =
                     {
                       ...
                       { RW, uint32, 4*sizeof (UNS32), (void*)&ObjDict_obj1016[0] }
                     };
...
/* index 0x1017 :   Producer Heartbeat Time. */
                    ...
                    subindex ObjDict_Index1017[] =
                     {
                       { RW, uint16, 2*sizeof (UNS16), (void*)&ObjDict_obj1017 }
                     };
                    ...
                    subindex ObjDict_Index1018[] =
                     {
                       ...
                       { RO, uint32, 4*sizeof (UNS32), (void*)&ObjDict_obj1018_Vendor_ID },
                       { RO, uint32, 4*sizeof (UNS32), (void*)&ObjDict_obj1018_Product_Code },
                       { RO, uint32, 4*sizeof (UNS32), (void*)&ObjDict_obj1018_Revision_Number },
                       { RO, uint32, 4*sizeof (UNS32), (void*)&ObjDict_obj1018_Serial_Number }
                     };

/* index 0x1200 :   Server SDO Parameter. */
                    UNS8 ObjDict_highestSubIndex_obj1200 = 2; /* number of subindex - 1*/
                    UNS32 ObjDict_obj1200_COB_ID_Client_to_Server_Receive_SDO = 0x600 + NodeId;	/* 1536 */
                    UNS32 ObjDict_obj1200_COB_ID_Server_to_Client_Transmit_SDO = 0x580 + NodeId;	/* 1408 */
                    subindex ObjDict_Index1200[] =
                     {
                       { RO, uint8, sizeof (UNS8), (void*)&ObjDict_highestSubIndex_obj1200 },
                       { RO, uint32, 4*sizeof (UNS32), (void*)&ObjDict_obj1200_COB_ID_Client_to_Server_Receive_SDO },
                       { RO, uint32, 4*sizeof (UNS32), (void*)&ObjDict_obj1200_COB_ID_Server_to_Client_Transmit_SDO }
                     };

/* index 0x1400 :   Receive PDO 1 Parameter. */
                    UNS8 ObjDict_highestSubIndex_obj1400 = 5; /* number of subindex - 1*/
                    UNS32 ObjDict_obj1400_COB_ID_used_by_PDO = 0x200 + NodeId;	/* 512 */
                    ...
                    subindex ObjDict_Index1400[] =
                     {
                       ...
                       { RW, uint32, 4*sizeof (UNS32), (void*)&ObjDict_obj1400_COB_ID_used_by_PDO },
                       { RW, uint8, sizeof (UNS8), (void*)&ObjDict_obj1400_Transmission_Type },
                       { RW, uint16, 2*sizeof (UNS16), (void*)&ObjDict_obj1400_Inhibit_Time },
                       { RW, uint8, sizeof (UNS8), (void*)&ObjDict_obj1400_Compatibility_Entry },
                       { RW, uint16, 2*sizeof (UNS16), (void*)&ObjDict_obj1400_Event_Timer }
                     };
                    ...
                    subindex ObjDict_Index1600[] =
                     {
                       ...
                       { RW, uint32, 4*sizeof (UNS32), (void*)&ObjDict_obj1600[0] }
                     };

/* index 0x1800 :   Transmit PDO 1 Parameter. */
                    UNS8 ObjDict_highestSubIndex_obj1800 = 5; /* number of subindex - 1*/
                    UNS32 ObjDict_obj1800_COB_ID_used_by_PDO = 0x180 + NodeId;	/* 384 */
                    UNS8 ObjDict_obj1800_Transmission_Type = 0x01;	/* 255 */
                    ...
                    subindex ObjDict_Index1800[] =
                     {
                       ...
                       { RW, uint32, 4*sizeof (UNS32), (void*)&ObjDict_obj1800_COB_ID_used_by_PDO },
                       { RW, uint8, sizeof (UNS8), (void*)&ObjDict_obj1800_Transmission_Type },
                       { RW, uint16, 2*sizeof (UNS16), (void*)&ObjDict_obj1800_Inhibit_Time },
                       { RW, uint8, sizeof (UNS8), (void*)&ObjDict_obj1800_Compatibility_Entry },
                       { RW, uint16, 2*sizeof (UNS16), (void*)&ObjDict_obj1800_Event_Timer }
                     };
                    ...
                    subindex ObjDict_Index1A00[] =
                     {
                       ...
                       { RW, uint32, 4*sizeof (UNS32), (void*)&ObjDict_obj1A00[0] }
                     };
